  ...
  return (
    <div className="actual-stuff-container">
      <Helmet>
        ...
        <meta
          property="og:title"
          content="ActualStuff - Copy of Togthr template"
        />
      </Helmet>
      <div className="actual-stuff-banner">
        <span className="actual-stuff-text">
          This is what it&apos;s all about
        </span>
        <h1 className="actual-stuff-text1">
          Let&apos;s start with an easy one
        </h1>
        <span className="actual-stuff-text2">
          We&apos;re going to find some amazing volunteer opportunities that are
          nearby
        </span>
        <input
          type="text"
      ...
      <div className="actual-stuff-testimonial">
        ...
        <div className="actual-stuff-testimonial1">
          ...
          <span className="actual-stuff-text6">
            Volunteering is the art of giving one&apos;s time and heart to paint
            a brighter canvas of compassion and community.
          </span>
          <div className="actual-stuff-container3">
            <svg
              viewBox="0 0 950.8571428571428 1024"
              className="actual-stuff-icon2"
            >
